(defproject pathfinder "0.0.1-SNAPSHOT"
  ...
  :source-paths ["src"]
  :javac-options ["-target" "1.6" "-source" "1.6" "-Xlint:-options" "-XX:-OmitStackTraceInFastThrow"]
  :aot [pathfinder.MyGame]
  :main pathfinder.desktop-launcher)